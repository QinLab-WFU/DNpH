...
scio.savemat('/home/admin00/DNPH/dataset/nuswide/index.mat', indexs)
# scio.savemat("caption.mat", captions)
scio.savemat('/home/admin00/DNPH/dataset/nuswide/label.mat', labels)


captions = [item + "\n" for item in captions["caption"]]

with open('/home/admin00/DNPH/dataset/nuswide/caption.txt', "w", encoding='utf-8') as f:
